...
import com.kleuton.backend.service.TaskStatusService;
...
public class TaskStatusController {
    ...
    public ResponseEntity<List<TaskStatus>> getAll() {
        List<TaskStatus> data = service.getAll();
    ...
    public ResponseEntity<Object> getById(@PathVariable Integer id, HttpServletResponse response) {
        try {
            TaskStatus data = service.getById(id);
            if (data != null) {
                return new ResponseEntity<>(data, HttpStatus.OK);
            } else {
    ...
    // Save Data
    @PostMapping
    public ResponseEntity<Object> createUser(@RequestBody TaskStatus data) {
        try {
            TaskStatus newData = service.save(data);
    ...
    // Update Data
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateUser(@PathVariable Integer id, @RequestBody TaskStatus data,
