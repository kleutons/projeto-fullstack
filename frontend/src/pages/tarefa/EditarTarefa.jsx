...
// Adicionando PropTypes ao componente
EditarTarefa.propTypes = {
  handleCloseEditar: PropTypes.func.isRequired,
  idTarefaSelecionada: PropTypes.oneOfType([PropTypes.number, PropTypes.string]).isRequired,
  tarefas: PropTypes.arrayOf(PropTypes.object).isRequired,
  tarefa: PropTypes.shape({
    tituloTarefa: PropTypes.string,
    descricaoTarefa: PropTypes.string,
    inicioTarefa: PropTypes.string,
    fimTarefa: PropTypes.string,
    recursoTarefa: PropTypes.string,
    statusTarefa: PropTypes.string,
  }).isRequired,
